...
### `gerador-de-prompts-para-imagens-de-produto/`
Versão especializada focada nos estilos fotográficos reais da Fast: `ambiente_pronto`, `obra_em_acao` e `detalhe_material` (sempre luz natural clara — ver `.claude/memory/feedback_linha_visual_fast.md`). Use quando a imagem precisa mostrar o produto da empresa.
